    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex items-center w-full space-x-4 lg:space-x-5 px-1 sm:py-1 py-0.5">
        ...
        <button onClick={onOpenComments}>
          <MessageCircle className="w-6 h-6 lg:w-7 lg:h-7 text-gray-300 hover:text-white transition" />
        </button>

        {/* Share */}
        <button>
          <Send className="w-6 h-6 lg:w-7 lg:h-7 text-gray-300 hover:text-white transition" />
        </button>
      </div>

      {/* Likes Count */}
      <div className="w-full px-1 py-1  text-xs lg:text-[14px]">
