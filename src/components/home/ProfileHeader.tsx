...
export default function ProfileHeader() {
  ...
  return (
    <div className="w-full mt-[60px] mb-3  md:mt-2 px-1">
      <div className="flex items-center justify-between p-3 md:p-4 bg-neutral-900 rounded-lg mb-1.5 sm:mb-2 border border-gray-800">
        <div>
          <p className="text-[16px] md:text-[18px] font-semibold text-white">
      ...
      <div className="border border-gray-700 rounded-lg px-3 md:px-4 py-2 md:py-3 bg-black">
        <input
          type="text"
